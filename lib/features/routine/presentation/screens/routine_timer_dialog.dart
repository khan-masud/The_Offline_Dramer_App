...
class RoutineTimerDialog extends ConsumerStatefulWidget {
  final RoutineItem item;
  const RoutineTimerDialog({super.key, required this.item});

  @override
  ConsumerState<RoutineTimerDialog> createState() => _RoutineTimerDialogState();
}

class _RoutineTimerDialogState extends ConsumerState<RoutineTimerDialog> {
  // Setup phase
